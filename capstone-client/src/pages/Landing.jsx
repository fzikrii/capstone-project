    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-white py-3 px-6 text-center">
        ...
        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
          Eagle.Eye helps you track tasks, build achievements, and showcase your
      ...
      <section className="bg-gradient-to-b from-blue-100 to-white py-16 px-6 text-center">
        ...
        <p className="max-w-4xl mx-auto text-gray-700 text-lg leading-relaxed">
          We believe that productivity should be meaningful. Eagle.Eye is built
      ...
      <footer className="bg-[#0B1C47] text-white text-center py-4">
        <p>&copy; {new Date().getFullYear()} Eagle.Eye. All rights reserved.</p>
      </footer>
    </div>
  );
};
